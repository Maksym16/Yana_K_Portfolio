          ...
          <div className="about-container">
            ...
            <div className="about-container__info-container">
              <div className="about-description">
                <h1>Hey, I’m Yana</h1>
                <p className="lead">
                  I am a multi-disciplinary designer specializing in UI/UX. I’ve
                  had experience in various design facets, including UX writing,
                  product and conceptual design. My approach is centered on
                  designing with empathy for the human experience.
                </p>
                <p className="lead">Love books, photography and piano music.</p>
              </div>
              <a
                href="./img/Yana_Kotliar_CV.pdf"
                target="_blank"
                type="button"
                className="cta"
              >
